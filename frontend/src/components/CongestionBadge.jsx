...
export default function CongestionBadge({ level }) {
  ...
  const className = colorMap[normalized] || 'bg-slate-700/30 text-slate-200 border border-slate-400/40';

  return (
    <span className={`px-2.5 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1 whitespace-nowrap ${className}`}>
